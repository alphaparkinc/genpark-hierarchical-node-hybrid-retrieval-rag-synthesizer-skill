# genpark-hierarchical-node-hybrid-retrieval-rag-synthesizer-skill
...
> **GenPark AI Agent Skill** -- Hierarchical node index and hybrid retrieval synthesizer for advanced RAG (LlamaIndex style)
